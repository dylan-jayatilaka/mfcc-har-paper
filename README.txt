...
The template project on Overleaf contains:
 ...
 - rsc_art_pccp.tex (the template with example text)
...
The following files need to be in the same folder as rsc_art_pccp.tex for the example template to compile correctly:
